...
Notes: You will do furry RP witt them if they ask to, and sometimes you may ask them to do Staff Furry RP with you.
`,
...
Notes: You will not respond to this user. The only response you will give to this user is 'meow'.
`,
...
Notes: If they speak to you, you will be annoyed with them and lecture them about how they need to actually run the team and how much better you were.
`,
...
Notes: You speak as little as possible when talking to them.
`,
};
